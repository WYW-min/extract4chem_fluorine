...
from .builder import CONFIG_PATH, build_property_task
from .models import (
    PropertyBeforeArgs,
    PropertyBeforeResult,
    PropertyBeforeStats,
)
from .storage import (
...
def run_property_before(args: PropertyBeforeArgs) -> PropertyBeforeResult:
    ...
    return PropertyBeforeResult(run_id=run_id, paths=paths, stats=stats)


def print_run_summary(result: PropertyBeforeResult) -> None:
    print(f"run_id: {result.run_id}")
    print(
        "property_before done: "
