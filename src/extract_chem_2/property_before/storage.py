...
from .models import PropertyBeforePaths, PropertyBeforeStats
    ...
    *,
    ...
    if out_jsonl:
        ...
        if inpath.parent.name == "main_signal_after":
            stage_dir = inpath.parent.parent / "property_before"
        else:
            stage_dir = inpath.parent / "property_before"
